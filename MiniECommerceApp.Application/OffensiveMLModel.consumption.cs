...
namespace MiniECommerceApp_Application
{
    public partial class OffensiveMLModel
    {
        /// <summary>
        /// model input class for OffensiveMLModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for OffensiveMLModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "OffensiveMLModel.mlnet");


        //private static string MLNetModelPath = Path.GetFullPath("OffensiveMLModel.mlnet");
